...
class ItemStateRenderer : PictureInPictureRenderer<ItemStateRenderer.State>() {
    ...
    override fun renderToTexture(renderState: State, poseStack: PoseStack, submitNodeCollector: SubmitNodeCollector) {
        ...
        renderState.state.itemStackRenderState().submit(poseStack, submitNodeCollector, LightCoordsUtil.FULL_BRIGHT, OverlayTexture.NO_OVERLAY, 0)
    }
